...
/**/) {
'use strict';var $utils=template.utils,$helpers=$utils.$helpers,$escape=$utils.$escape,title=$data.title,i=$data.i,list=$data.list,$out='';$out+='<h1>';
$out+=$escape(title);
$out+='</h1>\n<ul>\n    ';
...
var noEscapeTpl = __webpack_require__(2)
